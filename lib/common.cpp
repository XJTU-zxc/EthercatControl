        ...
        if (bits != 0) {
            if (g_axis_mvx_params[i].type == 1) {
                ...
                *g_params_axisPositionPtr[i] = g_axis_mvx_params[i].val;
                ...
                // 相对值编程
                switch(i) {
                case 0: *g_params_axisPositionPtr[i] = PostionRegs.real_pos.pos_x + g_axis_mvx_params[i].val; break;
                case 1: *g_params_axisPositionPtr[i] = PostionRegs.real_pos.pos_y + g_axis_mvx_params[i].val; break;
                case 2: *g_params_axisPositionPtr[i] = PostionRegs.real_pos.pos_z + g_axis_mvx_params[i].val; break;
                case 3: *g_params_axisPositionPtr[i] = PostionRegs.real_pos.pos_a + g_axis_mvx_params[i].val; break;
                case 4: *g_params_axisPositionPtr[i] = PostionRegs.real_pos.pos_b + g_axis_mvx_params[i].val; break;
                case 5: *g_params_axisPositionPtr[i] = PostionRegs.real_pos.pos_c + g_axis_mvx_params[i].val; break;
                case 6: *g_params_axisPositionPtr[i] = PostionRegs.real_pos.pos_w + g_axis_mvx_params[i].val; break;
                case 7: *g_params_axisPositionPtr[i] = PostionRegs.real_pos.pos_u + g_axis_mvx_params[i].val; break;
                }
            }
